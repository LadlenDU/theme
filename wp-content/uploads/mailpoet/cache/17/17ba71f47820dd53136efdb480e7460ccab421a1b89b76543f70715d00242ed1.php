...
class __TwigTemplate_a0a199606b4f7a354786e572f9c43c5687f67ceb428f888dee9e9a301a16b981 extends Twig_Template
{
...
<input type=\"text\" disabled=\"disabled\" value=\"\" placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" />";
    ...
    {
        return new Twig_Source("", "form/templates/blocks/text.hbs", "/mnt/hgfs/theme/wp-content/plugins/mailpoet/views/form/templates/blocks/text.hbs");
    }
}
